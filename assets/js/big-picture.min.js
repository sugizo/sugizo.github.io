...
return;$p=$e.data(key);$e.insertAfter($p);$e.removeData(key)}})}})(jQuery);(function($){skel.breakpoints({xxlarge:'(max-width: 1920px)',xlarge:'(max-width: 1680px)',large:'(max-width: 1280px)',medium:'(max-width: 1000px)',small:'(max-width: 736px)',xsmall:'(max-width: 480px)',});$(function(){var $window=$(window),$body=$('body'),$header=$('#header'),$all=$body.add($header);$body.addClass('is-loading');$window.on('load',function(){window.setTimeout(function(){$body.removeClass('is-loading')},0)});skel.on('change',function(){if(skel.vars.mobile||skel.breakpoint('small').active)
$body.addClass('is-touch');else $body.removeClass('is-touch')});$('form').placeholder();if(skel.vars.IEVersion<=11&&skel.vars.IEVersion>=10){var $main=$('.main.fullscreen'),IEResizeTimeout;$window.on('resize.ie-flexbox-fix',function(){clearTimeout(IEResizeTimeout);IEResizeTimeout=setTimeout(function(){var wh=$window.height();$main.each(function(){var $this=$(this);$this.css('height','');if($this.height()<=wh)
$this.css('height',(wh-50)+'px')})})}).triggerHandler('resize.ie-flexbox-fix')}
skel.on('+small -small',function(){$.prioritize('.important\\28 small\\29',skel.breakpoint('small').active)});$window.on('load',function(){var $gallery=$('.gallery');$gallery.poptrox({baseZIndex:10001,useBodyOverflow:!1,usePopupEasyClose:!1,overlayColor:'#1f2328',overlayOpacity:0.65,usePopupDefaultStyling:!1,usePopupCaption:!0,popupLoaderText:'',windowMargin:50,usePopupNav:!0});skel.on('-small',function(){$gallery.each(function(){$(this)[0]._poptrox.windowMargin=50})}).on('+small',function(){$gallery.each(function(){$(this)[0]._poptrox.windowMargin=5})})});if(skel.canUse('transition')){var on=function(){$('.gallery').scrollex({top:'30vh',bottom:'30vh',delay:50,initialize:function(){$(this).addClass('inactive')},terminate:function(){$(this).removeClass('inactive')},enter:function(){$(this).removeClass('inactive')},leave:function(){$(this).addClass('inactive')}});$('.main.style1').scrollex({mode:'middle',delay:100,initialize:function(){$(this).addClass('inactive')},terminate:function(){$(this).removeClass('inactive')},enter:function(){$(this).removeClass('inactive')},leave:function(){$(this).addClass('inactive')}});$('.main.style2').scrollex({mode:'middle',delay:100,initialize:function(){$(this).addClass('inactive')},terminate:function(){$(this).removeClass('inactive')},enter:function(){$(this).removeClass('inactive')},leave:function(){$(this).addClass('inactive')}});$('#contact').scrollex({top:'50%',delay:50,initialize:function(){$(this).addClass('inactive')},terminate:function(){$(this).removeClass('inactive')},enter:function(){$(this).removeClass('inactive')},leave:function(){$(this).addClass('inactive')}})};var off=function(){$('.gallery').unscrollex();$('.main.style1').unscrollex();$('.main.style2').unscrollex();$('#contact').unscrollex()};skel.on('change',function(){if(skel.breakpoint('small').active)(off)();else(on)()})}
